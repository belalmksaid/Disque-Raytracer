...
namespace DisqueEngine.Math
{
    public struct Vector3
    {
        public static Vector3 SmallGravity() { return new Vector3(0, -9.81f, 0); }
        public static Vector3 BigGravity() { return new Vector3(0, -20.0f, 0); }

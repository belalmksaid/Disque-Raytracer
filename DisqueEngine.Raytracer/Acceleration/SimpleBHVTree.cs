...
using DisqueEngine.Raytracer.GeometricObjects;
using DisqueEngine.Math;

namespace DisqueEngine.Raytracer.Acceleration
{
    ...
    public class SortByBoundingBox : IComparer<GeometricObject>
    {
        ...
        public int Compare(GeometricObject z, GeometricObject f)
        {
            ...
            if (MathUtil.Abs(a.X + a.Y + a.Z) > MathUtil.Abs(b.X + b.Y + b.Z))
                return 1;
            else if (MathUtil.Abs(a.X + a.Y + a.Z) < MathUtil.Abs(b.X + b.Y + b.Z))
                return -1;
            else
                return 0;
        }

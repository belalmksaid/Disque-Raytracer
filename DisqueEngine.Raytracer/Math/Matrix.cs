...
namespace DisqueEngine.Raytracer.Math
{
    ...
    //        MathUtil.Copy<float>(out minv, matrix);
    //        for (int i = 0; i < 4; i++)
    //        {
    //            int irow = -1, icol = -1;
    //            float big = 0;
    ...
    //                        if (ipiv[k] == 0)
    //                        {
    //                            if (MathUtil.Abs(minv[j, k]) >= big)
    //                            {
    //                                big = (MathUtil.Abs(minv[j, k]));
    //                                irow = j;
    //                                icol = k;
    //                            }
    //                        }
    ...
    //            {
    //                for (int k = 0; k < 4; ++k)
    //                    MathUtil.Swap<float>(ref minv[irow, k], ref minv[icol, k]);
    //            }
    //            indxr[i] = irow;
    //            indxc[i] = icol;
    //            if (minv[icol, icol] == 0)

...
using DisqueEngine.Raytracer.Materials;

namespace DisqueEngine.Raytracer.GeometricObjects
{
    public class Instance : GeometricObject
    {
        ...
        //    //float sin_theta = MathUtil.Sin(theta * MathUtil.PI / 180.0f);
        //    //float cos_theta = MathUtil.Cos(theta * MathUtil.PI / 180.0f);

...
namespace DisqueEngine.Raytracer.GeometricObjects.Primitives
{
    public class SmoothTriangle : GeometricObject
    {
        ...
        {
            float delta = 0.0001f;
            return (new BBox(MathUtil.Min(MathUtil.Min(v0.X, v1.X), v2.X) - delta, MathUtil.Max(MathUtil.Max(v0.X, v1.X), v2.X) + delta,
                        MathUtil.Min(MathUtil.Min(v0.Y, v1.Y), v2.Y) - delta, MathUtil.Max(MathUtil.Max(v0.Y, v1.Y), v2.Y) + delta,
                        MathUtil.Min(MathUtil.Min(v0.Z, v1.Z), v2.Z) - delta, MathUtil.Max(MathUtil.Max(v0.Z, v1.Z), v2.Z) + delta));
        }

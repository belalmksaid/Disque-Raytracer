...
namespace DisqueEngine.Raytracer.GeometricObjects.CompoundObjects
{
    ...
    {        
        ...
        Vector3 find_min_bounds()
        {
            ...
            p0.X -= MathUtil.Epsilon; 
            p0.Y -= MathUtil.Epsilon;
            p0.Z -= MathUtil.Epsilon;
            return p0;
        }
        ...
        Vector3 find_max_bounds()
        {
            ...
            p1.X += MathUtil.Epsilon; p1.Y += MathUtil.Epsilon; p1.Z += MathUtil.Epsilon;
            return (p1);
        }
        ...
        public void SetupCells()
        {
            ...
            float s = MathUtil.Pow(wx * wy * wz / num_objects, 0.3333333f);
